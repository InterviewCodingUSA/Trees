...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println(leafSimilarTree(tree1, tree2));

    }

    private static boolean leafSimilarTree(BinTree<Integer> tree1, BinTree<Integer> tree2){
        ArrayList<Integer>  list1 = tree1.getAllLeaves();
        ArrayList<Integer>  list2 = tree2.getAllLeaves();
